...
const translations = {
  ...
  Dutch: {
    ...
    'home.feature2Desc': 'Onze AI creëert een actie-packed titel, samenvatting en poster',
  ...
  French: {
    ...
    'home.heroTitle': 'Transformez N\'importe Quelle Comédie Romantique En<br><span class="highlight">Blockbuster D\'Action</span>',
    'home.heroSubtitle': 'Parce que même les comédies romantiques méritent des explosions et des poursuites... tout est mieux avec de l\'adrénaline!',
    'home.startRomanticizing': 'Commencer à Actionner',
    'home.howItWorks': 'Comment Ça Marche',
    'home.feature1Title': 'Entrez Une Rom-Com',
    'home.feature1Desc': 'Tapez n\'importe quel titre de comédie romantique ou histoire d\'amour',
    'home.feature2Title': 'L\'IA Le Transforme',
    'home.feature2Desc': 'Notre IA crée un titre d\'action, un résumé et une affiche',
    'home.feature3Title': 'Affiche Explosive',
    'home.feature3Desc': 'Obtenez une superbe affiche de film d\'action générée par IA',
    ...
    'transform.creatingPoster': 'Création de l\'affiche d\'action...',
    ...
    'top10.title': 'Top 10 sur Netflix - Actionné!',
    'top10.subtitle': 'Transformez les comédies romantiques et histoires d\'amour les plus populaires en blockbusters d\'action explosifs',
    ...
    'top10.scifiCategory': 'Drame & Comédie',
    ...
    'top10.romanticGenre.series': 'Séries TV d\'Action',
    ...
    'collection.emptyMessage': 'Commencez à actionner des films pour construire votre collection!',
    ...
    'collection.cat.fantasyLove': 'Épopées d\'Action Fantastique',
    'collection.cat.sciFiRomance': 'Guerre Sci-Fi',
    'collection.cat.gothicRomance': 'Action Sombre & Noir',
    'collection.cat.comedyRomance': 'Montée d\'Adrénaline',
  ...
  Spanish: {
    ...
    'home.heroTitle': 'Transforma Cualquier Rom-Com En<br><span class="highlight">Un Blockbuster de Acción</span>',
    'home.heroSubtitle': 'Porque hasta las comedias románticas merecen explosiones y persecuciones... ¡todo es mejor con adrenalina!',
    'home.startRomanticizing': 'Comenzar a Actionizar',
    'home.howItWorks': 'Cómo Funciona',
    'home.feature1Title': 'Ingresa Una Rom-Com',
    'home.feature1Desc': 'Escribe cualquier título de comedia romántica o historia de amor',
    'home.feature2Title': 'La IA Lo Transforma',
    'home.feature2Desc': 'Nuestra IA crea un título de acción, resumen y póster',
    'home.feature3Title': 'Póster Explosivo',
    'home.feature3Desc': 'Obtén un impresionante póster de película de acción generado por IA',
    'home.feature4Title': 'Guardar en Colección',
    'home.feature4Desc': 'Construye tu colección personal de películas de acción',
    ...
    'transform.creatingPoster': 'Creando póster de acción...',
    ...
    'top10.title': '¡Top 10 en Netflix - Actionizado!',
    'top10.subtitle': 'Transforma las rom-coms y historias de amor más populares en blockbusters de acción explosivos',
    ...
    'top10.romanticGenre.movies': 'Películas de Acción',
    'top10.romanticGenre.series': 'Series de TV de Acción',
    'top10.romanticGenre.action': 'Acción Pura',
    'top10.romanticGenre.scifi': 'Thrillers de Acción',
    'collection.title': 'Mi Colección de Acción',
    'collection.individualMovies': 'Transformaciones Individuales',
    'collection.noMovies': 'Sin Películas Aún',
    'collection.emptyMessage': '¡Comienza a actionizar películas para construir tu colección!',
    'collection.transformMovie': 'Transformar una Película',
    'collection.originally': 'Originalmente',
    'collection.featured': 'Acción Destacada',
    ...
    'collection.cat.actionRomance': 'Acción Pura',
    'collection.cat.fantasyLove': 'Épicas de Acción Fantástica',
    'collection.cat.sciFiRomance': 'Guerra Sci-Fi',
    'collection.cat.gothicRomance': 'Acción Oscura y Noir',
    'collection.cat.comedyRomance': 'Subida de Adrenalina',
    'collection.cat.classicRomance': 'Películas de Acción Clásicas',
    ...
    'toast.addingMagic': 'Añadiendo magia de acción...',
    'toast.creatingPoster': 'Creando póster de acción...',
  ...
  German: {
    ...
    'home.heroSubtitle': 'Denn selbst romantische Komödien verdienen Explosionen und Verfolgungsjagden... alles ist besser mit Adrenalin!',
    ...
    'home.feature4Desc': 'Baue deine persönliche Action-Filmsammlung auf',
    ...
    'collection.featured': 'Ausgewählte Action',
    ...
    'toast.addingMagic': 'Füge Action-Magie hinzu...',
  ...
  Italian: {
    ...
    'home.heroSubtitle': 'Perché anche i film horror meritano un lieto fine... e tutto è meglio con un tocco d\'azione!',
    ...
    'top10.subtitle': 'Trasforma le rom-com più popolari in blockbuster d\'azione esplosivi',
    ...
    'collection.cat.passionateDramas': 'Thriller ad Alta Velocità',
  ...
  Portuguese: {
    ...
    'home.heroTitle': 'Transforme Qualquer Rom-Com Em<br><span class="highlight">Um Blockbuster de Ação</span>',
    'home.heroSubtitle': 'Porque até filmes de terror merecem um final feliz... e tudo fica melhor com um toque de ação!',
    'home.startRomanticizing': 'Começar a Actionizar',
    ...
    'home.feature2Desc': 'Nossa IA cria um título de ação, resumo e pôster',
    ...
    'transform.romanticize': 'Actionizar',
    'transform.romanticizing': 'Actionizando...',
    'transform.creatingPoster': 'Criando pôster de ação...',
    'transform.originally': 'Originalmente',
    ...
    'top10.subtitle': 'Transforme as rom-coms mais populares em blockbusters de ação explosivos',
    ...
    'collection.title': 'Minha Coleção de Ação',
    ...
    'collection.originally': 'Originalmente',
    'collection.featured': 'Ação em Destaque',
    ...
    'collection.cat.actionRomance': 'Ação Pura',
    ...
    'collection.cat.classicRomance': 'Filmes de Ação Clássicos',
    ...
    'toast.addingMagic': 'Adicionando magia de ação...',
    'toast.creatingPoster': 'Criando pôster de ação...',
  ...
  Japanese: {
    ...
    'home.heroTitle': 'あらゆるラブコメを<br><span class="highlight">アクション大作</span>に変換',
    'home.heroSubtitle': 'ラブコメでも爆発とカーチェイスに... アドレナリンで全てがもっと良くなります！',
    'home.startRomanticizing': 'アクション化を開始',
    'home.howItWorks': '使い方',
    'home.feature1Title': '映画を入力',
    'home.feature1Desc': 'ラブコメや恋愛映画のタイトルを入力',
    'home.feature2Title': 'AIが変換',
    'home.feature2Desc': 'AIがアクション満載のタイトル、あらすじ、ポスターを作成',
    'home.feature3Title': '爆発的なポスター',
    'home.feature3Desc': 'AIが生成した素敵なロマンス映画ポスターを取得',
    'home.feature4Title': 'コレクションに保存',
    'home.feature4Desc': 'あなただけのロマンス映画コレクションを作成',
    'transform.title': '映画を変換',
    'transform.inputPlaceholder': 'ラブコメのタイトルを入力（例：きみに読む物語、ラブ・アクチュアリー...）',
    'transform.romanticize': 'アクション化',
    'transform.romanticizing': 'アクション化中...',
    'transform.creatingPoster': 'アクションポスターを作成中...',
    ...
    'top10.title': 'Netflixトップ10 - アクション化！',
    'top10.subtitle': '人気のラブコメを爆発的なアクション大作に変換',
    'top10.moviesCategory': '今日のあなたの国の映画',
    'top10.seriesCategory': '今日のあなたの国のTV番組',
    'top10.actionCategory': 'ロマンス映画',
    'top10.scifiCategory': 'SF & スリラー',
    'top10.romanticize': 'アクション化',
    'top10.romanticizeAll': '10作品全てをアクション化',
    'top10.romanticizing': 'アクション化中...',
    'top10.romanticGenre.movies': 'アクション映画',
    'top10.romanticGenre.series': 'アクションTVシリーズ',
    'top10.romanticGenre.action': 'ピュアアクション',
    'top10.romanticGenre.scifi': 'アクションスリラー',
    'collection.title': 'マイアクションコレクション',
    'collection.individualMovies': '個別変換',
    'collection.noMovies': 'まだ映画がありません',
    'collection.emptyMessage': '映画をアクション化してコレクションを作りましょう！',
    'collection.transformMovie': '映画を変換する',
    'collection.originally': '原題',
    'collection.featured': '注目のアクション',
    'collection.moreInfo': '詳細情報',
    'collection.cat.recentlyAdded': '最近追加',
    'collection.cat.passionateDramas': 'ハイオクタンスリラー',
    'collection.cat.starCrossedLovers': 'ライバル戦士',
    'collection.cat.actionRomance': 'ピュアアクション',
    'collection.cat.fantasyLove': 'ファンタジーアクション叙事詩',
    'collection.cat.sciFiRomance': 'SF戦争',
    'collection.cat.gothicRomance': 'ダークアクション＆ノワール',
    'collection.cat.comedyRomance': 'アドレナリンラッシュ',
    'collection.cat.classicRomance': 'クラシックアクション映画',
    'settings.title': '設定',
    ...
    'toast.addingMagic': 'アクション満載の魔法を追加中...',
    'toast.creatingPoster': 'アクションポスターを作成中...',
  ...
  Korean: {
    ...
    'home.heroTitle': '모든 로맨틱 코미디를<br><span class="highlight">액션 블록버스터</span>로 변환',
    'home.heroSubtitle': '로맨틱 코미디도 폭발과 자동차 추격전을 받을 자격이 있습니다... 아드레날린으로 모든 것이 더 좋아집니다!',
    'home.startRomanticizing': '액션화 시작',
    ...
    'home.feature3Title': '폭발적인 포스터',
    'home.feature3Desc': 'AI가 생성한 멋진 로맨스 영화 포스터를 받으세요',
    'home.feature4Title': '컬렉션에 저장',
    'home.feature4Desc': '나만의 액션 영화 컬렉션을 만드세요',
    'transform.title': '영화 변환',
    'transform.inputPlaceholder': '영화 제목 입력 (예: 다이하드, 터미네이터, 매드맥스...)',
    'transform.romanticize': '액션화',
    'transform.romanticizing': '액션화 중...',
    'transform.creatingPoster': '액션 포스터 생성 중...',
    ...
    'top10.title': '넷플릭스 톱 10 - 액션화!',
    'top10.subtitle': '가장 인기 있는 영화와 시리즈를 로맨틱 걸작으로 변환',
    'top10.moviesCategory': '오늘 당신 나라의 영화',
    'top10.seriesCategory': '오늘 당신 나라의 TV 프로그램',
    'top10.actionCategory': '로맨스 영화',
    'top10.scifiCategory': 'SF & 스릴러',
    'top10.romanticize': '액션화',
    'top10.romanticizeAll': '10개 모두 액션화',
    'top10.romanticizing': '액션화 중...',
    'top10.romanticGenre.movies': '액션 영화',
    'top10.romanticGenre.series': '액션 TV 시리즈',
    'top10.romanticGenre.action': '순수 액션',
    'top10.romanticGenre.scifi': '액션 스릴러',
    'collection.title': '내 액션 컬렉션',
    'collection.individualMovies': '개별 변환',
    'collection.noMovies': '아직 영화가 없습니다',
    'collection.emptyMessage': '영화를 액션화하여 컬렉션을 만들어 보세요!',
    ...
    'collection.cat.passionateDramas': '하이 옥탄 스릴러',
    'collection.cat.starCrossedLovers': '라이벌 전사',
    ...
    'toast.creatingPoster': '액션 포스터 생성 중...',
  ...
  Chinese: {
    ...
    'home.feature3Title': '爆炸性海报',
    'home.feature3Desc': '获取AI生成的精美动作电影海报',
    'home.feature4Title': '保存到收藏',
    'home.feature4Desc': '建立您的个人动作电影收藏',
    'transform.title': '转换您的电影',
    'transform.inputPlaceholder': '输入电影标题（例如：虎胆龙威、终结者、疯狂的麦克斯...）',
    'transform.romanticize': '动作化',
    'transform.romanticizing': '正在动作化...',
    'transform.creatingPoster': '正在创建动作海报...',
    ...
    'top10.title': 'Netflix前10 - 已动作化！',
    'top10.subtitle': '将最热门的电影和剧集转变为浪漫杰作',
    'top10.moviesCategory': '今日您所在国家的电影',
    'top10.seriesCategory': '今日您所在国家的电视节目',
    'top10.actionCategory': '爱情电影',
    'top10.scifiCategory': '科幻 & 惊悚',
    'top10.romanticize': '动作化',
    'top10.romanticizeAll': '动作化全部10部',
    'top10.romanticizing': '正在动作化...',
    'top10.romanticGenre.movies': '动作电影',
    'top10.romanticGenre.series': '动作电视剧',
    'top10.romanticGenre.action': '纯动作',
    'top10.romanticGenre.scifi': '动作惊悚',
    'collection.title': '我的动作收藏',
    'collection.individualMovies': '单独转换',
    'collection.noMovies': '还没有电影',
    'collection.emptyMessage': '开始动作化电影来建立您的收藏！',
    ...
    'collection.cat.sciFiRomance': '科幻战争',
    'collection.cat.gothicRomance': '哥特与暗黑浪漫',
    'collection.cat.comedyRomance': '肾上腺素飙升',
    'collection.cat.classicRomance': '经典动作电影',
    'settings.title': '设置',
    ...
    'toast.addingMagic': '正在添加动作魔法...',
    'toast.creatingPoster': '正在创建动作海报...',
...
function updateRomanticizeAllProgress(modal, currentMovie, totalMovies, movieTitle, step) {
  ...
  const stepDescriptions = {
    ...
    'title': '✍️ Creating action-packed title...',
    'story': '📖 Writing explosive story...',
    'poster': '🎨 Generating action poster...',
    'complete': '✅ Complete!',
    'error': '❌ Error (continuing with next)',
    'done': '🎉 All movies actionized!'
  };
  ...
  if (step === 'done') {
    ...
    currentStep.textContent = '🎉 All movies have been actionized and saved to your collection!';
  }
}
